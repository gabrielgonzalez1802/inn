...
public class JwtUtil {
    ...
    public void validateToken(final String token) throws JwtValidationException {
        try {
            ...
            throw new JwtValidationException("La firma del token no es válida", e);
