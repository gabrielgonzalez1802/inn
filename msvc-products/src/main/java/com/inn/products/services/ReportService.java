...
public class ReportService {
	...
	public byte[] generarReporteMonthlyPDF(List<ProductMovementWeeklyDTO> movements, LocalDateTime fechaInicio, LocalDateTime fechaFin, Long movementTypeId, Long warehouseId) throws Exception {
	...
	public byte[] generarReporteMonthlyXLSX(List<ProductMovementWeeklyDTO> movements, LocalDateTime fechaInicio,
			LocalDateTime fechaFin, Long movementTypeId, Long warehouseId) throws JRException {
	...
	public byte[] generarReporteFinMesPDF(List<ProductMovementSummaryDTO> movements, LocalDateTime fechaInicio, LocalDateTime fechaFin, Integer semana, Long warehouseId) throws Exception {
	...
	public byte[] generarReporteFinMesXLSX(List<ProductMovementSummaryDTO> movements, LocalDateTime fechaInicio, LocalDateTime fechaFin, Integer semana, Long warehouseId) throws Exception {
