...
public class ProductTerminatedDTO {
    ...
    public ProductTerminatedDTO() {
		super();
	}
    
	public ProductTerminatedDTO(String nombre, Double invInicial, Double recepcion, Double despacho, Double merma,
			Double invFinal) {
		super();
		this.nombre = nombre;
	...
	public Double getRecepcion() {
		return recepcion;
	}
	public void setRecepcion(Double recepcion) {
		this.recepcion = recepcion;
	}
